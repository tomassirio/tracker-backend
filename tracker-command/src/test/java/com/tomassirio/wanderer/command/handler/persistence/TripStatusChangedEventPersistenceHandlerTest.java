...
class TripStatusChangedEventPersistenceHandlerTest {
    ...
    @InjectMocks private TripStatusChangedEventPersistenceHandler handler;
    ...
    void handle_whenTripExists_shouldUpdateTripStatus() {
        ...
        assertThat(savedTrip.getTripSettings().getTripStatus()).isEqualTo(TripStatus.IN_PROGRESS);
    }
