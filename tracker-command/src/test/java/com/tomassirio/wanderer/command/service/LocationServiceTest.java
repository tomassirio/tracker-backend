...
class LocationServiceTest {
    ...
    void createLocationUpdate_whenTripExists_shouldCreateAndSaveLocation() {
        ...
        LocationUpdateRequest request = new LocationUpdateRequest(TestEntityFactory.LATITUDE, TestEntityFactory.LONGITUDE, null, 100.0, 10.0, 80, "test-device");
        ...
        assertThat(createdLocation.getTimestamp()).isCloseTo(Instant.now(), within(1, ChronoUnit.SECONDS));
    ...
    void createLocationUpdate_withSpecificTimestamp_shouldUseProvidedTimestamp() {
        ...
        LocationUpdateRequest request = new LocationUpdateRequest(TestEntityFactory.LATITUDE, TestEntityFactory.LONGITUDE, timestampString, null, null, null, "test");
