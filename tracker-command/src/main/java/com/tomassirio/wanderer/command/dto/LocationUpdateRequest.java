...
public record LocationUpdateRequest(
        ...
        @NotNull(message = "Longitude is required")
                ...
                @DecimalMax(
                        ...
                        message = "Longitude must be between -180 and 180 degrees")
                Double longitude,
        @PastOrPresentInstantString String timestamp, // ISO-8601 format
        @DecimalMin(value = "-1000.0", message = "Altitude seems too low")
                @DecimalMax(value = "10000.0", message = "Altitude seems too high")
                Double altitude,
        @DecimalMin(value = "0.0", message = "Accuracy must be positive") Double accuracy,
        ...
        @Size(max = 100, message = "Source must be less than 100 characters") String source) {}
